...
const AppUpdate = props => {
  const playstore_url =
    'https://play.google.com/store/apps/details?id=com.daffodilhealth.Parentapp';
  return (
    <>
      <StatusBar
      ...
      <View style={styles.container}>
        <Image
          ...
          source={require('../../assets/images/AppUpdate/appUpdate-top-cloudfull.png')}
        />
        <Image
          style={{...styles.funnyCloud, width: '100%', height: '40%'}}
          source={require('../../assets/images/AppUpdate/appUpdate-funny-cloud-bg.gif')}
        />
      ...
      {props.notNow ? (
        <View
          ...
          <Image
            ...
            source={require('../../assets/images/AppUpdate/btmCloud.png')}
          />
          <Image
